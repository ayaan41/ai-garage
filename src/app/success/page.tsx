  ...
  return (
    <div style={{ padding: "40px", maxWidth: "600px", margin: "0 auto", color: "white", background: "#111", minHeight: "100vh", textAlign: "center" }}>
      ...
      <div style={{ marginTop: "30px", padding: "20px", border: "1px solid #333", borderRadius: "12px", background: "#1a1a1a" }}>
        ...
        <p style={{ fontSize: "12px", color: "#666", marginTop: "15px" }}>Garage: {garage.slice(0,8).toUpperCase()}</p>
      </div>
      <div style={{ marginTop: "30px", display: "flex", gap: "10px" }}>
        ...
        <Link href="/" style={{ flex: 1, padding: "14px", background: "#222", color: "white", fontWeight: "bold", borderRadius: "8px", border: "1px solid #333", textDecoration: "none" }}>Home</Link>
      </div>
    </div>
  );
}
